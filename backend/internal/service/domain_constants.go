...
// IsMultiProtocolAPIKeyProvider reports whether the provider supports adaptive protocol dispatch.
...
const (
	...
	// Existing subscriptions and administrator management remain available when disabled.
