...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		RegistrationIPCooldownEnabled:                          settings.RegistrationIPCooldownEnabled,
		RegistrationIPCooldownSeconds:                          settings.RegistrationIPCooldownSeconds,
		...
		SubNexusInviteRewardsEnabled:                           settings.SubNexusInviteRewardsEnabled,
		SubNexusInviteRewardInviterAmount:                      settings.SubNexusInviteRewardInviterAmount,
		SubNexusInviteRewardInviteeAmount:                      settings.SubNexusInviteRewardInviteeAmount,
		SubNexusInviteRewardIPLimitEnabled:                     settings.SubNexusInviteRewardIPLimitEnabled,
		SubNexusInviteRewardIPDailyLimit:                       settings.SubNexusInviteRewardIPDailyLimit,
