...
let pollCount = 0
// Generation is capped at 30 minutes; the backend lease adds a save margin.
// Poll for 32 minutes at 2s intervals so long-running tests remain visibly
// pending instead of appearing complete; hidden/unmounted cancellation remains unchanged.
const MAX_STATUS_POLLS = 960
