export default {
  ...
  payment: {
    ...
    studentRecharge: {
      modeTitle: 'Recharge mode',
      eligible: 'Student eligibility is active for this account',
      standard: 'Standard recharge',
      student: 'Student offer',
      bonus: 'Student bonus',
      calculating: 'Calculating...',
      totalCredited: 'Total credited',
      minimum: 'Minimum student recharge is {amount}',
      unavailable: 'The student offer is unavailable for this amount',
    },
    methods: {
      easypay: 'EasyPay',
      alipay: 'Alipay',
