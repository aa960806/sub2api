    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          modeV3Hint: 'Reuses V2 passive aggregation data with the refreshed user-facing channel status interface; no upstream probe traffic is sent.',
        ...
        affiliate: {
          ...
          signupRewards: {
            title: 'Invite Signup Rewards',
            description: 'Grant a one-time balance reward to the inviter and the new user after an invitation is bound. Independent from recharge rebates and disabled by default.',
            enabled: 'Enable Invite Signup Rewards',
            enabledHint: 'Rewards are written only when this switch is explicitly enabled; missing or disabled settings do not write balances or ledgers.',
            inviterAmount: 'Inviter Reward Amount',
            inviterAmountHint: 'Balance credited to the inviter for each valid invitation binding; 0 disables this side of the reward.',
            inviteeAmount: 'New User Reward Amount',
            inviteeAmountHint: 'Balance credited to the new user for each valid invitation binding; 0 disables this side of the reward.',
            ipLimit: 'Enable Daily Same-IP Limit',
            ipLimitHint: 'Limit how many signup rewards a trusted client IP can trigger per day.',
            ipDailyLimit: 'Daily Reward Limit per IP',
            ipDailyLimitHint: 'Applies only when the IP limit is enabled; must be an integer greater than or equal to 1.',
          },
          customUsers: {
      ...
      registration: {
        ...
        ipCooldown: 'Registration IP Cooldown',
        ipCooldownHint: 'Prevent repeated new account creation from the same trusted client IP.',
        ipCooldownSeconds: 'Cooldown Seconds',
        ipCooldownSecondsHint: 'Range: 1-86400 seconds. Existing accounts can still sign in normally.',
      ...
      site: {
        ...
        defaultLanguageHint: 'Used when a user has not selected a language locally. Leave empty to follow the browser language.',
        defaultLanguageBrowser: 'Follow browser',
        defaultLanguageZh: 'Chinese',
        defaultLanguageEn: 'English',
        customerSupport: 'Customer support button',
        customerSupportHint: 'Show a floating support button only when enabled and Markdown content is not empty.',
        customerSupportContent: 'Customer support Markdown',
        customerSupportContentPlaceholder: 'Enter support instructions, contact details, or a QR image in Markdown.',
        customerSupportContentHint: 'HTML is sanitized before display. Leave empty to hide the support entry.',
