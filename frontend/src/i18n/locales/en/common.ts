export default {
  common: {
    ...
    userMenu: 'User menu',
    visualMode: 'Visual performance',
    visualModeHint: 'Balanced keeps a still rain scene; compatibility uses the original background and cards. Saved in this browser only.',
    visualModeCurrent: 'Current: {mode}',
    visualModes: {
    ...
    checkin: {
      ...
      continuous: '{count} consecutive days',
      day: 'Day {day}',
      milestone: 'Milestone',
      milestoneBadge: 'Gift',
      daily: 'Daily check-in',
      disabled: 'Not enabled',
      frozenToday: 'Checked in today; reward is frozen',
      claimed: 'Checked in today',
      pending: 'Check-in available',
      frozen: '${amount} frozen; recharge to unlock it',
      recharge: 'Recharge to unlock',
      milestoneDone: 'Milestone day {day} completed',
      claimMilestone: 'Claim the day {day} milestone reward',
      futureMilestone: 'Milestone day {day} unlocks on a future day',
      dayDone: 'Day {day} completed',
      claimDay: 'Claim the day {day} reward',
      futureDay: 'Day {day} unlocks on a future day',
      claimedFrozen: 'Check-in recorded; reward frozen until recharge',
      claimedAmount: 'Check-in recorded: ${amount}',
  ...
  nav: {
    ...
    paymentPlans: 'Plans',
    firstRechargeGift: 'First Recharge Gift',
