...
export default {
  channelMonitorV2: {
    ...
    admin: {
      ...
      descriptionV3: '当前系统设置为 V3 展示：底层使用 V2 被动监控数据；V1 主动探测不会运行。',
      tabAria: '监控管理',
      tabV2: 'V2 / V3 监控配置',
      tabV1Active: 'V1 主动探测',
  ...
  channelMonitorV3: {
    settings: {
      orderTitle: '厂商与分组排序',
      orderHint: '使用箭头调整 V3 厂商分区顺序，展开厂商可调整其分组顺序。保存后对所有用户生效。',
      groupOrderTitle: '分组顺序（{count}）',
      groupOrderHint: '仅列出下方分组范围内的分组，排序不会改变用户可访问的分组。',
      compositeOrderHint: '综合分组会列在各厂商下；分组在对应厂商产生监控数据时，使用该处设置的顺序。',
      groupOrderEmpty: '当前分组范围内没有此厂商的分组。',
      vendorDisabled: '此厂商尚未启用，启用后将使用已保存的顺序。',
      moveUp: '上移 {name}',
      moveDown: '下移 {name}',
    },
    title: '渠道状态',
    description: '基于真实网关流量的分组状态概览',
    updatedTo: '更新至 {time}',
    partialCoverage: '部分历史覆盖',
    ...
    ttft: '首 Token P50',
    loadFailed: '渠道状态加载失败',
    emptyTitle: '暂无可展示的渠道状态',
    emptyDescription: '当前时间范围内没有可用的分组监控数据。',
    ranges: { '90m': '90m', '24h': '24h', '7d': '7d', '30d': '30d' },
