export default {
  common: {
    ...
    userMenu: '用户菜单',
    visualMode: '视觉性能',
    visualModeHint: '轻量保留静态雨景，兼容使用原版背景和卡片。仅保存在当前浏览器。',
    visualModeCurrent: '当前：{mode}',
    visualModes: {
      auto: '自动（推荐）',
      standard: '标准',
      balanced: '轻量',
    ...
    checkin: {
      title: '每日签到',
      continuous: '连续签到 {count} 天',
      day: '第 {day} 天',
      milestone: '连续礼盒',
      milestoneBadge: '礼盒',
      daily: '每日签到',
      disabled: '未开启',
      frozenToday: '今日已签到，奖励冻结中',
      claimed: '今日已签到',
      pending: '今日待签到',
      frozen: '已累计冻结 ${amount}，充值后自动解锁到余额',
      recharge: '充值解锁签到',
      milestoneDone: '第 {day} 天连续礼盒已完成',
      claimMilestone: '签到领取第 {day} 天连续礼盒',
      futureMilestone: '第 {day} 天连续礼盒将在后续自然日解锁',
      dayDone: '第 {day} 天已完成',
      claimDay: '签到领取第 {day} 天奖励',
      futureDay: '第 {day} 天将在后续自然日解锁',
      claimedFrozen: '签到成功，奖励已冻结，充值后解锁',
      claimedAmount: '签到成功，获得 ${amount}',
      claimFailed: '签到失败',
    },
    view: '查看',
    settings: '设置',
  ...
  nav: {
    ...
    myOrders: '我的订单',
    invoices: '发票管理',
    invoiceManagement: '发票事务',
    orderManagement: '订单管理',
    paymentDashboard: '支付概览',
    paymentConfig: '支付配置',
    paymentPlans: '订阅套餐',
    firstRechargeGift: '首充礼包',
