...
const task: ModelEvaluationTask = { id: 4, name: 'Task', group_id: 7, group_name: 'Group', endpoint: 'https://api.example.com/v1/messages', api_format: 'messages', model: 'claude-example', enabled: true, interval_seconds: 3600, retention_days: 7, max_records: 50, has_api_key: true, next_run_at: null, created_at: '', updated_at: '' }
