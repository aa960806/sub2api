  ...
  <div class="card">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="user-glass-inset flex items-center justify-between rounded-xl bg-gray-50 p-4 transition-colors hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
