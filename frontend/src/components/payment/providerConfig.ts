...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'bepusdt'] as const
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  bepusdt: [
    ...
    { key: 'tradeType', label: 'Trade Type', sensitive: false, defaultValue: 'usdt.trc20' },
    { key: 'fiat', label: 'Fiat Currency', sensitive: false, defaultValue: 'CNY', options: [{ value: 'CNY', label: 'CNY' }] },
    { key: 'timeout', label: 'Timeout (seconds)', sensitive: false, optional: true, defaultValue: '600' },
  ],
}
