...
const BADGE: Record<Platform, string> = {
  ...
  seedance: 'bg-cyan-800/10 text-cyan-800 border-cyan-800/30 dark:bg-cyan-500/10 dark:text-cyan-200 dark:border-cyan-500/30',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  seedance: 'bg-cyan-800/10 text-cyan-800 dark:bg-cyan-500/10 dark:text-cyan-200',
...
const BORDER: Record<Platform, string> = {
  ...
  seedance: 'border-cyan-800/20 dark:border-cyan-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  seedance: 'border-cyan-800/35 dark:border-cyan-500/35',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  seedance: 'bg-gradient-to-r from-cyan-700 to-cyan-900',
...
const TEXT: Record<Platform, string> = {
  ...
  seedance: 'text-cyan-800 dark:text-cyan-200',
...
const BUTTON: Record<Platform, string> = {
  ...
  seedance: 'bg-cyan-800 text-white hover:bg-cyan-900 active:bg-black dark:bg-cyan-700 dark:hover:bg-cyan-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  seedance: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-800 dark:text-cyan-200',
...
const GRADIENT: Record<Platform, string> = {
  ...
  seedance: 'from-cyan-700 to-cyan-900',
